...
describe('create todo should work', async () => {
  ...
  it('Should return the object that was craeted with ID with isDone = false withput isDone being given', async () => {
    const newTodo = {
      title: 'New Todo',
  ...
  it('Should return the object that was craeted with ID with isDone = to the given object', async () => {
    const newTodo = {
      title: 'New Todo 2',
